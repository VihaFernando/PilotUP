        ...
        >
          ...
          <div
            ...
            className="
              ...
              /* SHADOW */
              shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.5)]
          ...
          >
            ...
            <button
              onClick={handleClose}
              className="absolute top-3 right-3 p-1 text-gray-400 hover:text-white sm:hidden"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto pr-6 sm:pr-0">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-2">
                  <h3 className="text-[14px] sm:text-[16px] font-bold text-white tracking-tight leading-tight">
                    Join the PilotUP Waitlist
                  </h3>
                  {/* Beta tag hidden on very small screens to save width, visible on sm+ */}
                  <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-900/30 text-[10px] font-bold text-blue-300 uppercase tracking-wide">
                    <Sparkles className="w-2.5 h-2.5" />
                    Beta
                  </span>
                </div>
                <p className="text-[12px] sm:text-[14px] text-gray-400 font-medium leading-tight sm:leading-snug mt-0.5 sm:mt-0 pr-2 sm:pr-0">
